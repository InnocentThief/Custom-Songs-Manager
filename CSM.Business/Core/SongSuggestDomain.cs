    ...
    internal class SongSuggestDomain(IUserConfigDomain userConfigDomain) : ISongSuggestDomain
    {
        ...
        private SongSuggestSettings GetSongSuggestSettings(string? playerId)
        {
            ...
            return new SongSuggestSettings
            {
                ...
                IgnoreNonImproveable = userConfigDomain.Config?.SongSuggestConfig.SongSuggestSettings.IgnoreNonImproveable ?? true,
                ...
                BetterAccCap = userConfigDomain.Config?.SongSuggestConfig.SongSuggestSettings.BetterAccCap ?? 1.2,
                WorseAccCap = userConfigDomain.Config?.SongSuggestConfig.SongSuggestSettings.WorseAccCap ?? 0.7,
