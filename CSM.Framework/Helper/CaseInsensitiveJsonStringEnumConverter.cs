...
public class CaseInsensitiveJsonStringEnumConverter : JsonConverterFactory
{
    private readonly Dictionary<Type, Dictionary<string, object>> customMappings;

    public CaseInsensitiveJsonStringEnumConverter(Dictionary<Type, Dictionary<string, object>>? customMappings = null)
    {
        this.customMappings = customMappings ?? new Dictionary<Type, Dictionary<string, object>>();
    }
    ...
    public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return (JsonConverter)Activator.CreateInstance(
            ...
            null,
            new object[] { customMappings.ContainsKey(enumType) ? customMappings[enumType] : null },
            null)!;
    }
